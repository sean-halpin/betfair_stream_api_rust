...
pub struct AppConfig {
    ...
    pub app_key: String,
    #[envconfig(from = "STREAM_API_ENDPOINT", default = "stream-api-integration.betfair.com:443")]
    pub stream_api_endpoint: String,
    #[envconfig(from = "STREAM_API_HOST", default = "stream-api-integration.betfair.com")]
